...
<input className="form-input flex w-full rounded-xl text-[#111813] focus:outline-0 focus:ring-2 focus:ring-primary border border-[#dbe6df] bg-white h-14 placeholder:text-[#61896f] px-4 text-base font-normal" placeholder="seu@email.com" name="email"  required/>
</div>
{/*Password Field*/}
<div className="flex flex-col gap-2">
<label className="text-[#111813] text-base font-medium leading-normal">Senha</label>
<div className="relative flex items-stretch">
<input className="form-input flex w-full rounded-xl text-[#111813] focus:outline-0 focus:ring-2 focus:ring-primary border border-[#dbe6df] bg-white h-14 placeholder:text-[#61896f] px-4 pr-12 text-base font-normal" placeholder="Sua senha" type="password" required/>
...
{/*Submit Button*/}
<button className="w-full bg-primary text-[#111813] font-bold h-14 rounded-xl hover:bg-primary/90 transition-all text-lg mt-4" type="submit">
                    Entrar
                </button>
</LoginForm>
